...
echo "ooooo      IDE INSTALL      ooooo" >> /home/$5/install.progress.txt
...
sudo -u $5 wget https://github.com/Microsoft/vsts-agent/releases/download/v2.105.2/vsts-agent-ubuntu.16.04-x64-2.105.2.tar.gz
...
echo "Downloading and Installing Java ALM IDE lib dependencies" >> /home/$5/install.progress.txt
